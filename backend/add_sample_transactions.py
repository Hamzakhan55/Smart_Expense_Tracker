...
def add_sample_transactions():
    ...
    try:
        ...
        expenses = [
            ...
            {"amount": 200.00, "category": "Bills & Fees", "description": "Electricity bill"},
            ...
            {"amount": 150.00, "category": "Bills & Fees", "description": "Internet bill"},
            {"amount": 90.00, "category": "Transport", "description": "Car maintenance"},
            {"amount": 22.00, "category": "Food & Drinks", "description": "Pizza delivery"},
            {"amount": 65.00, "category": "Shopping", "description": "Books and supplies"},
        ]
